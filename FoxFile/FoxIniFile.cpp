...
* 备  注：
******************************************************************************/
INI_RES FoxIniFile::openFile(const char* pathName, const char* type)
{
    ...
    if (m_fp == nullptr)
    {        
        FoxLoggerFactory::getLogger()->error("open inifile %s error!", pathName);
...
* 备  注：
******************************************************************************/
INI_RES FoxIniFile::getKey(const char* mAttr, const char* cAttr, char* pValue)
{
...
* 备  注：
******************************************************************************/
int FoxIniFile::getInt(const char* mAttr, const char* cAttr)
{
    int nRes = 0;
...
* 备  注：
******************************************************************************/
const char* FoxIniFile::getStr(const char* mAttr, const char* cAttr)
{
    memset(m_szKey, 0, sizeof(m_szKey));
